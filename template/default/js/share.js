function NewOdnaknopka2() {
	...
	div.style.backgroundImage='url('+WWW_ROOT+'/data/img/share-panel.png)';
	div.style.border='0';
	div.style.margin='0';
	...
	for (var i=0;i<12;i++) {
	html+='<noindex><a rel="nofollow" href="'+this.url(i+1)+'" style="display:block;float:left;width:108px;height:16px;overflow:hidden;margin:1px 0;padding:0 0 0 24px;background-color:transparent;background:url('+WWW_ROOT+'/data/img/share-panel.png) no-repeat -266px '+(-i*16)+'px;font:normal 12px arial;color:#666;text-decoration:none;text-align:left;text-shadow:none" onmouseover="this.style.textDecoration=\'underline\'" onmouseout="this.style.textDecoration=\'none\'" onclick="return odnaknopka2.go('+(i+1)+');">'+titles[i]+'</a></noindex>';
	}
	div.innerHTML=html;
	...
	document.write('<img src="'+WWW_ROOT+'/data/img/share-button.gif" width="136" height="16" alt="Ì? ג סמצסוע?ץ" title="Ì? ג סמצסוע?ץ" style="border:0;margin:0;padding:0" onmouseover="odnaknopka2.show(this);" onmouseout="odnaknopka2.timeout=setTimeout(\'odnaknopka2.hide()\',500);">');
	}
}
