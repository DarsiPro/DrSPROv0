...
<div class="row">
    ...
    <form id="DrsForm" style="opacity:1;" method="POST" action="">
...
<script type="text/javascript" src="<?php echo WWW_ROOT ?>/admin/js/jquery-ui.min.js"></script>
<script type="text/javascript" src="<?php echo WWW_ROOT ?>/admin/js/jquery.validate.js"></script>
<script type="text/javascript" src="<?php echo WWW_ROOT ?>/admin/js/jquery.cookie.js"></script>
<script type="text/javascript" src="<?php echo WWW_ROOT ?>/admin/js/jquery.hotkeys.js"></script>
<script type="text/javascript" src="<?php echo WWW_ROOT ?>/modules/pages/admin/jstree/jstree.min.js"></script>
