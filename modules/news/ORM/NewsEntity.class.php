...
class NewsEntity extends \OrmEntity
{
    ...
    public function getCategories_singly()
    {
        ...
        $catsModel = \OrmManager::getModelInstance('NewsCategories');
        ...
        $categories = array();
        if (isset($Register['news_categories'])) $categories = $Register['news_categories'];
        ...
        $Register['news_categories'] = $categories;
        return $this->categories;
    }
